...
public enum ResultCode implements IResultCode, Serializable {
    ...
    REFRESH_TOKEN_INVALID_OR_EXPIRED("A0232", "token无效或已过期"),
    USER_FIRST("A0233", "用户第一次登录，需要绑定手机"),
    USER_WX_TOKEN_UNAUTHORIZED("A0234", "微信授权信息效验失败"),

    AUTHORIZED_ERROR("A0300", "访问权限异常"),
    ACCESS_UNAUTHORIZED("A0301", "token无效或已过期"),

    FORBIDDEN_OPERATION("A0302", "演示环境禁止修改、删除重要数据，请本地部署后测试"),
    TENANT_ERROR("A0303", "租户信息异常"),
